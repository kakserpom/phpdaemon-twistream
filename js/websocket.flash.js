...
// Reference: http://tools.ietf.org/html/draft-hixie-thewebsocketprotocol
  ...
  WebSocket.__initialize = function() {
    ...
    swfobject.embedSWF(
      WebSocketFlashSWFPath, "webSocketFlash",
  ...
  window.webSocketLog = function(message) {
    console.log(decodeURIComponent(decodeURIComponent(message)));
  };

  // called from Flash
  window.webSocketError = function(message) {
    console.error(decodeURIComponent(decodeURIComponent(message)));
  };
